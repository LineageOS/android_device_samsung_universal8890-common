...
patchelf --replace-needed libprotobuf-cpp-full.so libprotobuf-cpp-lite-v29.so $BLOB_ROOT/vendor/lib/libwvhidl.so
patchelf --replace-needed libprotobuf-cpp-full.so libprotobuf-cpp-lite-v29.so $BLOB_ROOT/vendor/lib/mediadrm/libwvdrmengine.so
